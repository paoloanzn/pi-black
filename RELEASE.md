...
This release updates the Claude Code protocol to 2.1.280 in both the Pi package and standalone binaries, addressing `claude_code_version_too_old` errors. The standalone build remains based on Pi 0.84.1; the package supports Pi 0.84.1 or newer.
